...
aurora-siger/
│
├── aurora_siger_completo.ipynb     # Notebook principal com todo o código e análises
├── relatorio_aurora_siger.pdf      # Relatório gerado (não editável neste repositório)
...
1. Acesse o notebook diretamente pelo link:  
   👉 [Abrir no Google Colab](https://colab.research.google.com/github/rlcjuliaguimaraes-collab/aurora-siger/blob/rlcjuliaguimaraes-collab-patch-1/aurora_siger_completo.ipynb)
